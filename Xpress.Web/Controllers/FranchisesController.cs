...
namespace Xpress.Web.Controllers
{
    ...
    public class FranchisesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LegalId,LegalName,PicturePath,Rating,Id,Name")] Franchise franchise)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LegalId,LegalName,PicturePath,Rating,Id,Name")] Franchise franchise)
        {
            if (id != franchise.Id)
            {
                return NotFound();
