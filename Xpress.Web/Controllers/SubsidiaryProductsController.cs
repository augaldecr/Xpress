...
namespace Xpress.Web.Controllers
{
    public class SubsidiaryProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Rating,Active")] SubsidiaryProduct subsidiaryProduct)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Rating,Active")] SubsidiaryProduct subsidiaryProduct)
        {
