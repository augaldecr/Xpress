...
namespace Xpress.Web.Controllers
{
    public class ProductsToDeliverController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Description,Barcode,Price,PicturePath,Id,Name")] ProductToDeliver productToDeliver)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Description,Barcode,Price,PicturePath,Id,Name")] ProductToDeliver productToDeliver)
        {
